...
Ez a modul még nem API endpoint és nem adatbázis-entitás. A célja az, hogy egy
setup candidate reprodukálható, auditálható 0-100 közötti pontszámot kapjon.
...
A következő Phase 4 szeletben a TradingView webhook payloadból belső
`SetupScoringInput` mappolást kell készíteni. Utána a webhook ingestion flow
már pontozott setup candidate-et is elő tud állítani.
